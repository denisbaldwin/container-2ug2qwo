...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2ug2qwo.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2ug2qwo.containers.anotherwebservice.com/
...
```
git clone git@github.com:denisbaldwin/container-2ug2qwo.git
cd container-2ug2qwo
```
...
```
docker attach container-2ug2qwo
```
